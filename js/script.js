...
/* change color of elements when mouse hovers over each respective element.
when an element is hovered over, the typewrite text is replaced with the section title*/
